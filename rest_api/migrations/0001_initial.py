# Generated by Django 3.1 on 2022-02-04 00:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abonnes', models.ManyToManyField(blank=True, related_name='abonne', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecteurs', models.ManyToManyField(blank=True, related_name='lecteurs', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Like',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('articlemagazine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articlerepost', to='rest_api.document')),
                ('commentaires', models.ManyToManyField(related_name='commentRepost', to='rest_api.Commentaire')),
                ('likes', models.ManyToManyField(related_name='likesrepost', to='rest_api.Like')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userrepost', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Lecture',
        ...
        migrations.AddField(
            model_name='document',
            name='repost',
            field=models.ManyToManyField(blank=True, related_name='repost_doc', to='rest_api.Repost'),
        ),
        migrations.AddField(
            model_name='commentaire',
            name='likes',
            field=models.ManyToManyField(blank=True, related_name='like_reponses', to='rest_api.Like'),
        ),
        migrations.AddField(
            model_name='commentaire',
            name='reponses',
            field=models.ManyToManyField(blank=True, related_name='reponse', to='rest_api.Commentaire'),
        ),
        migrations.AddField(
            model_name='commentaire',
            name='user',
